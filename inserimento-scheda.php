...
//$emailUtente
	...
	require('functions/config.php');
  	...
  	$query= "SELECT max(id_scheda) as idmax FROM scheda";    
	...
	function getRow($queryf) {
			...
			if( mysqli_num_rows($resultf) >= 1 )
				return mysqli_fetch_array($resultf, MYSQLI_ASSOC);	
			}
		  }
...
if(isset($_POST['Agg_libro']))
{
   ...
   $autore = (isset($_POST['Autore_l'])) ? trim($_POST['Autore_l']) : ''; 
	...
	$privato = (isset($_POST['bool_privato'])) ? trim($_POST['bool_privato']) : '';
	...
	$edizione = (isset($_POST['Edizione'])) ? trim($_POST['Edizione']) : '';  
		  ...
		  $idSchedaL = getIdScheda(); 

        $strSQL = "INSERT INTO scheda (id_scheda, titolo,email_utente,autore,keywords,descrizione,privato,anno,url) VALUES('$idSchedaL','$titolo','$emailUtente','$autore','$keywords','$descrizione','$privato','$anno','$url');";
        
		  $strSQL .= "INSERT INTO libro (id_scheda, casa_editrice, edizione) VALUES('$idSchedaL','$casaEditrice','$edizione')";        
        
	     mysqli_multi_query($link, $strSQL) OR die("Errore, contattare l'amministratore ".mysql_error());
      
        echo "<script type=\"text/javascript\">alert(\"Inserito con successo!\");</script> ";  
...
else if(isset($_POST['Agg_atto']))
{
   ...
   $autore = (isset($_POST['Autore_a'])) ? trim($_POST['Autore_a']) : ''; 
	...
	$idSchedaA = getIdScheda(); 

   $strSQL = "INSERT INTO scheda (id_scheda,titolo,email_utente,autore,keywords,descrizione,privato,anno,url) VALUES('$idSchedaA','$titolo','$emailUtente','$autore','$keywords','$descrizione','$privato','$anno','$url');";
        
	$strSQL .= "INSERT INTO atto (id_scheda,nome,data,luogo,inizio,fine) VALUES('$idSchedaA','$nomeConf','$dataConf','$luogoConf','$paginaIniziale','$paginaFinale')";        
...
else if(isset($_POST['Agg_capitolo']))
{
   ...
   $autore = (isset($_POST['Autore_c'])) ? trim($_POST['Autore_c']) : ''; 
	...
	$idSchedaC = getIdScheda(); 
		  
   $strSQL = "INSERT INTO scheda (id_scheda,titolo,email_utente,autore,keywords,descrizione,privato,anno,url) VALUES('$idSchedaC','$titolo','$emailUtente','$autore','$keywords','$descrizione','$privato','$anno','$url');";
        
	$strSQL .= "INSERT INTO capitolo (id_scheda,titolo_libro,curatore,casa_editrice,inizio,fine) VALUES('$idSchedaC','$titoloCap','$nomeCur','$casaEditrice','$paginaIniziale','$paginaFinale')";        
...
else if(isset($_POST['Agg_articolo']))
{
   ...
   $autore = (isset($_POST['Autore_r'])) ? trim($_POST['Autore_r']) : ''; 
	...
	$idSchedaR = getIdScheda(); 

   $strSQL = "INSERT INTO scheda (id_scheda,titolo,email_utente,autore,keywords,descrizione,privato,anno,url) VALUES('$idSchedaR','$titolo','$emailUtente','$autore','$keywords','$descrizione','$privato','$anno','$url');";
        
	$strSQL .= "INSERT INTO rivista (id_scheda,volume,numero,inizio,fine) VALUES('$idSchedaR','$volume','$numeroRivista','$paginaIniziale','$paginaFinale')";        
...
else if(isset($_POST['Agg_doc']))
{
   ...
   $autore = (isset($_POST['Autore_d'])) ? trim($_POST['Autore_d']) : ''; 
	...
	$idSchedaD = getIdScheda(); 
	

   $strSQL = "INSERT INTO scheda (id_scheda,titolo,email_utente,autore,keywords,descrizione,privato,anno,url) VALUES('$idSchedaD','$titolo','$emailUtente','$autore','$keywords','$descrizione','$privato','$anno','$url');";
        
	$strSQL .= "INSERT INTO doctecnico (id_scheda) VALUES('$idSchedaD')";  
...
//variabili di controllo
		...
		var flag_anno_pub=0;
		var flag_url=0;
		var flag_descrizione=0;
//flag per dinamici		
		var flag_casa=0;
		var flag_edizione=0;
		var flag_nome_conf=0;
		var flag_luogo_conf=0;
		var flag_data_conf=0;
		var flag_num_i_atto=0;
		var flag_num_f_atto=0;
		var flag_titolo_cap=0;
		var flag_nome_cur=0;
		var flag_casa2=0;
		var flag_num_i_cap=0;
		var flag_num_f_cap=0;
		var flag_volume_riv=0;
		var flag_numero_riv=0;
		var flag_num_i_riv=0;
		var flag_num_f_riv=0;
...
function displayInsTab(tipodoc)
{

		//alert( tipodoc.toString() );
		
		//var elem = tipodoc;	
	   //	alert(elem);
	    
	    //document.getElementById("tab_inserimento").style.display = 'block';
...
<div id="contenuto">
	 ...
	 if( $tipoUtente == "Responsabile" )   /* $tipoUtente è definita in /common/header.php */
   	...
   	include 'common/menu_user.php'; 
		...
		<p class="p_notifica"> </p>		
		
		<h1>Inserimento</h1>
		
		<p>Scegli il tipo di documento da inserire: </p>
...
<table id="libro" class="tab_scheda" style="display: none">  <!-- cancellato l'id tab_inserimento -->
		
		<tr>
			<td>Titolo *</td>
			<td><input type="text" id="Titolo_l" name="Titolo_l" onblur="return controlloTitolo(1);"/></td>
		</tr>
		<tr>
			<td>Autore *</td>
			<td><input type="text" id="Autore_l" name="Autore_l" onblur="return controlloAutore(1);"/></td>
		</tr>
		<tr>
			<td>Parole chiave (separate da virgola) *</td>
			<td><input type="text" id="Keyword_l" name="Keyword_l" onblur="return controlloKeyword(1);"/></td>
		</tr>
		<tr>
			<td>Privato? *</td>
			<td>Si <input type="radio" name="bool_privato" value="1" checked="true" />
				 No <input type="radio" name="bool_privato" value="0" />
					</td>
		</tr>
		<tr>
			<td>Anno di pubblicazione * </td>
			<td><input type="text" id="Anno_pub_l" name="Anno_pub_l" onblur="return controlloAnno_pub(1);"/></td>
		</tr>	
		<tr>
			<td>URL per il download *</td>
			<td><input type="text" id="Url_l" name="Url_l" onblur="return controlloUrl(1);"/></td>
		</tr>	
		<tr>
			<td>Breve descrizione sul documento *</td>
			<td><textarea rows='6' id="Descrizione_l" name="Descrizione_l" onblur="return controlloDescrizione(1);"></textarea></td>
		</tr>
      ...
      <!-- Qui campi dinamici (javascript) -->
		...
		<tr >
			<td>Casa editrice *</td>
			<td><input type="text" name="Casa" id="Casa" onblur="return controlloCasa();"/></td>
		</tr>
		<tr>
			<td>Edizione *</td>
			<td><input type="text" name="Edizione" id="Edizione" onblur="return controlloEdizione();"/></td>
		</tr>
		<tr>
		<tr >
			<td colspan="2"><input name="Agg_libro" id="Agg_scheda_libro" type="submit" value="Aggiungi libro" style="display: none" /></td>
		</tr>
		<tr>
...
<table id="atto" class="tab_scheda" style="display: none">			
		
		<tr>
			<td>Titolo *</td>
			<td><input type="text" id="Titolo_a" name="Titolo_a" onblur="return controlloTitolo(3);"/></td>
		</tr>
		<tr>
			<td>Autore *</td>
			<td><input type="text" id="Autore_a" name="Autore_a" onblur="return controlloAutore(3);"/></td>
		</tr>
		<tr>
			<td>Parole chiave (separate da virgola) *</td>
			<td><input type="text" id="Keyword_a" name="Keyword_a" onblur="return controlloKeyword(3);"/></td>
		</tr>
		<tr>
			<td>Privato? *</td>
			<td>Si <input type="radio" name="bool_privato" value="1" checked="true" />
		...
		<tr>
			<td>Anno di pubblicazione * </td>
			<td><input type="text" id="Anno_pub_a" name="Anno_pub_a" onblur="return controlloAnno_pub(3);"/></td>
		</tr>	
		<tr>
			<td>URL per il download *</td>
			<td><input type="text" id="Url_a" name="Url_a" onblur="return controlloUrl(3);"/></td>
		</tr>	
		<tr>
			<td>Breve descrizione sul documento *</td>
			<td><textarea rows='6' id="Descrizione_a" name="Descrizione_a" onblur="return controlloDescrizione(3);"></textarea></td>
		</tr>
		
		<tr>
			<td>Nome della conferenza *</td>
			<td><input type="text" name="Nome_conf" id="Nome_conf" onblur="return controlloNome_conf();"/></td>
		</tr>
		<tr>
			<td>Luogo della conferenza *</td>
			<td><input type="text" name="Luogo_conf" id="Luogo_conf" onblur="return controlloLuogo_conf();"/></td>
		</tr>
		<tr>
			<td>Data della conferenza *</td>
			<td><input type="text" name="Data_conf" id="Data_conf" onblur="return controlloData_conf();"/></td>
		</tr>
		<tr>
			<td>Numero di pagine iniziale *</td>
			<td><input type="text" name="Num_i_atto" id="Num_i_atto" onblur="return controlloNum_i_atto();"/></td>
		</tr>
		<tr>
			<td>Numero di pagine finale *</td>
			<td><input type="text" name="Num_f_atto" id="Num_f_atto" onblur="return controlloNum_f_atto();"/></td>
		</tr>
		<tr >
			<td colspan="2"><input name="Agg_atto" id="Agg_scheda_atto" type="submit" value="Aggiungi atto" style="display: none" /></td>
		</tr>
		<tr>
		<td colspan="2"><p> <strong> Tutti i campi contrassegnati da * sono obbligatori. </strong> </p></td>
		</tr>
...
<table id="capitolo" class="tab_scheda" style="display: none">	
		<tr>
			<td>Titolo *</td>
			<td><input type="text" id="Titolo_c" name="Titolo_c" onblur="return controlloTitolo(5);"/></td>
		</tr>
		<tr>
			<td>Autore *</td>
			<td><input type="text" id="Autore_c" name="Autore_c" onblur="return controlloAutore(5);"/></td>
		</tr>
		<tr>
			<td>Parole chiave (separate da virgola) *</td>
			<td><input type="text" id="Keyword_c" name="Keyword_c" onblur="return controlloKeyword(5);"/></td>
		</tr>
		<tr>
			<td>Privato? *</td>
			<td>Si <input type="radio" name="bool_privato" value="1" checked="true" />
		...
		<tr>
			<td>Anno di pubblicazione * </td>
			<td><input type="text" id="Anno_pub_c" name="Anno_pub_c" onblur="return controlloAnno_pub(5);"/></td>
		</tr>	
		<tr>
			<td>URL per il download *</td>
			<td><input type="text" id="Url_c" name="Url_c" onblur="return controlloUrl(5);"/></td>
		</tr>	
		<tr>
			<td>Breve descrizione sul documento *</td>
			<td><textarea rows='6' id="Descrizione_c" name="Descrizione_c" onblur="return controlloDescrizione(5);"></textarea></td>
		</tr>
		
		<tr>
			<td>Titolo del libro *</td>
			<td><input type="text" name="Titolo_cap" id="Titolo_cap" onblur="return controlloTitolo_cap();"/></td>
		</tr>
		
		<tr>
			<td>Nome del curatore *</td>
			<td><input type="text" name="Nome_cur" id="Nome_cur" onblur="return controlloNome_cur();"/></td>
		</tr>
		<tr>
			<td>Casa editrice *</td>
			<td><input type="text" name="Casa2" id="Casa2" onblur="return controlloCasa2();"/></td>
		</tr>
		<tr>
			<td>Numero di pagine iniziale *</td>
			<td><input type="text" name="Num_i_cap" id="Num_i_cap" onblur="return controlloNum_i_cap();"/></td>
		</tr>
		<tr>
			<td>Numero di pagine finale *</td>
			<td><input type="text" name="Num_f_cap" id="Num_f_cap" onblur="return controlloNum_f_cap();"/></td>
		</tr>
		<tr >
			<td colspan="2"><input name="Agg_capitolo" id="Agg_scheda_capitolo" type="submit" value="Aggiungi capitolo" style="display: none" /></td>
		</tr>
		<tr>
		<td colspan="2"><p> <strong> Tutti i campi contrassegnati da * sono obbligatori. </strong> </p></td>
		</tr>
...
<table id="rivista" class="tab_scheda" style="display: none">
		<tr>
			<td>Titolo *</td>
			<td><input type="text" id="Titolo_r" name="Titolo_r" onblur="return controlloTitolo(2);"/></td>
		</tr>
		<tr>
			<td>Autore *</td>
			<td><input type="text" id="Autore_r" name="Autore_r" onblur="return controlloAutore(2);"/></td>
		</tr>
		<tr>
			<td>Parole chiave (separate da virgola) *</td>
			<td><input type="text" id="Keyword_r" name="Keyword_r" onblur="return controlloKeyword(2);"/></td>
		</tr>
		<tr>
			<td>Privato? *</td>
			<td>Si <input type="radio" name="bool_privato" value="1" checked="true" />
		...
		<tr>
			<td>Anno di pubblicazione * </td>
			<td><input type="text" id="Anno_pub_r" name="Anno_pub_r" onblur="return controlloAnno_pub(2);"/></td>
		</tr>	
		<tr>
			<td>URL per il download *</td>
			<td><input type="text" id="Url_r" name="Url_r" onblur="return controlloUrl(2);"/></td>
		</tr>	
		<tr>
			<td>Breve descrizione sul documento *</td>
			<td><textarea rows='6' id="Descrizione_r" name="Descrizione_r" onblur="return controlloDescrizione(2);"></textarea></td>
		</tr>
			
		<tr>
			<td>Volume</td>
			<td><input type="text" name="Volume_riv" id="Volume_riv" onblur="return controlloVolume_riv();"/></td>
		</tr>
		<tr>
			<td>Numero rivista</td>
			<td><input type="text" name="Numero_riv" id="Numero_riv" onblur="return controlloNumero_riv();"/></td>
		</tr>
		<tr>
			<td>Numero di pagine iniziale *</td>
			<td><input type="text" name="Num_i_riv" id="Num_i_riv" onblur="return controlloNum_i_riv();"/></td>
		</tr>
		<tr>
			<td>Numero di pagine finale *</td>
			<td><input type="text" name="Num_f_riv" id="Num_f_riv" onblur="return controlloNum_f_riv();"/></td>
		</tr>
		<tr >
			<td colspan="2"><input name="Agg_articolo" id="Agg_scheda_articolo" type="submit" value="Aggiungi articolo" style="display: none" /></td>
		</tr>
		<tr>
		<td colspan="2"><p> <strong> Tutti i campi contrassegnati da * sono obbligatori. </strong> </p></td>
		</tr>
...
<table id="doc_tecnico" class="tab_scheda" style="display: none">  <!-- cancellato l'id tab_inserimento -->
		
		<tr>
			<td>Titolo *</td>
			<td><input type="text" id="Titolo_d" name="Titolo_d" onblur="return controlloTitolo(4);"/></td>
		</tr>
		<tr>
			<td>Autore *</td>
			<td><input type="text" id="Autore_d" name="Autore_d" onblur="return controlloAutore(4);"/></td>
		</tr>
		<tr>
			<td>Parole chiave (separate da virgola) *</td>
			<td><input type="text" id="Keyword_d" name="Keyword_d" onblur="return controlloKeyword(4);"/></td>
		</tr>
		<tr>
			<td>Privato? *</td>
			<td>Si <input type="radio" name="bool_privato" value="1" checked="true" />
		...
		<tr>
			<td>Anno di pubblicazione * </td>
			<td><input type="text" id="Anno_pub_d" name="Anno_pub_d" onblur="return controlloAnno_pub(4);"/></td>
		</tr>	
		<tr>
			<td>URL per il download *</td>
			<td><input type="text" id="Url_d" name="Url_d" onblur="return controlloUrl(4);"/></td>
		</tr>	
		<tr>
			<td>Breve descrizione sul documento *</td>
			<td><textarea rows='6' id="Descrizione_d" name="Descrizione_d" onblur="return controlloDescrizione(4);"></textarea></td>
		</tr>
		<tr>
			<td colspan="2"><input name="Agg_doc" id="Agg_scheda_documento" type="submit" value="Aggiungi rapporto tecnico" style="display: none" /></td>
		</tr>
		<tr>
		<td colspan="2"><p> <strong> Tutti i campi contrassegnati da * sono obbligatori. </strong> </p></td>
		</tr>
